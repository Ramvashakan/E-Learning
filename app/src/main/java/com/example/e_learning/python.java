...
public class python extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mywebview.loadUrl("https://www.tutorialspoint.com/python/index.htm");
...

        {
            ...
            public boolean onNavigationItemSelected (@NonNull MenuItem menuItem){
                ...
                switch (id) {
                    ...
                    case R.id.java:
                        i = new Intent(python.this, java_activity.class);
                        startActivity(i);
                        break;

                    case R.id.python:
                        i = new Intent(python.this, python.class);
                        startActivity(i);
                        break;

                    case R.id.c_language:
                        i = new Intent(python.this, Clanguage.class);
                        startActivity(i);
                        break;

                    case R.id.javascript:
                        i = new Intent(python.this, javaScript.class);
                        startActivity(i);
                        break;
                }
