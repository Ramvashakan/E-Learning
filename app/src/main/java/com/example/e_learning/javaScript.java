...
public class javaScript extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drawerLayout1 = findViewById(R.id.drawer_layout5);



        mywebview =(WebView) findViewById(R.id.webview);

        mywebview.loadUrl("https://www.tutorialspoint.com/javascript/index.htm");
...

        {
            ...
            public boolean onNavigationItemSelected (@NonNull MenuItem menuItem){
                ...
                switch (id) {
                    ...
                    case R.id.java:
                        i = new Intent(javaScript.this, java_activity.class);
                        startActivity(i);
                        break;

                    case R.id.python:
                        i = new Intent(javaScript.this, python.class);
                        startActivity(i);
                        break;

                    case R.id.c_language:
                        i = new Intent(javaScript.this, Clanguage.class);
                        startActivity(i);
                        break;

                    case R.id.javascript:
                        i = new Intent(javaScript.this, javaScript.class);
                        startActivity(i);
                        break;
                }
